    ...
    <div className="space-y-8 animate-fade-in max-w-[95rem] mx-auto pb-10">
      <div className="text-center">
        ...
        {currentPlan !== PlanType.FREE && (
          ...
          >
            <CreditCard size={18} /> Manage Subscription <ExternalLink size={14} />
          </button>
        )}
      </div>
             ...
             <div 
              ...
              >
                ...
                <button 
                  ...
                  disabled={isCurrent || isFree || processingPlan !== null || loadingProducts}
                ...
                >
                  ...
                  {isCurrent ? 'Current Plan' : isFree ? 'Free Forever' : isEnterprise ? 'Get Enterprise' : `Choose ${plan.name}`}
                </button>
             </div>
           );
         })}
