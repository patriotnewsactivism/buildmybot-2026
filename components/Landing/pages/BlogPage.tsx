...
const blogPosts = [
  {
    ...
    excerpt: 'BuildMyBot offers a comprehensive suite of AI-powered tools designed to transform how businesses interact with customers. From our intuitive no-code bot builder with multiple persona options to advanced voice agents powered by Cartesia, lead capture CRM, marketing automation, and white-label partner capabilities—discover every feature that makes BuildMyBot the all-in-one platform for modern customer engagement. Whether you need a simple FAQ bot or a sophisticated sales assistant that works 24/7, BuildMyBot has you covered.',
    date: 'January 2, 2026',
  ...
  },
  {
    ...
    excerpt: 'Hiring, training, and managing customer service teams is expensive. Missed calls mean missed opportunities. BuildMyBot customers report significant reductions in operational costs by automating routine inquiries, eliminating after-hours staffing needs, and reducing the time employees spend on repetitive questions. Learn how companies are reallocating resources from answering the same questions repeatedly to strategic initiatives that drive growth—all while maintaining (and often improving) customer satisfaction scores.',
...
const categories = ['All', 'Product Features', 'Industry Insights', 'Business Strategy', 'Growth & Revenue'];
    ...
    <PageLayout>
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 space-y-16">
        <section className="text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900">BuildMyBot Blog</h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Insights, strategies, and tips on AI automation, lead generation, and customer engagement.
          </p>
        </section>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <div className="text-slate-500 text-sm">
                      <span className="text-slate-700 font-medium">Matthew Reardon</span> · {post.date}
                    </div>
            ...
            {filteredPosts.map((post) => (
              ...
              >
                <div className="flex items-center gap-2 mb-3 text-sm">
                  ...
                  <span className="text-blue-700 font-medium">{post.category}</span>
                </div>
                ...
                <div className="flex items-center justify-between text-sm text-slate-500">
                  <span><span className="text-slate-700 font-medium">Matthew Reardon</span> · {post.date}</span>
        ...
        <section className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-blue-200 mb-8 max-w-xl mx-auto">
            Get the latest AI insights and product updates delivered to your inbox. No spam, just valuable content.
          </p>
