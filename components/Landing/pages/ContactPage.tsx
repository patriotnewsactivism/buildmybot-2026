    ...
    <PageLayout>
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 space-y-16">
        <section className="text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900">Contact Us</h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Have a question or need help? We're here for you. Reach out and our team will get back to you within 24 hours.
          </p>
        </section>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@buildmybot.app" className="text-blue-700 hover:underline">
            ...
            <div className="bg-gradient-to-br from-blue-900 to-blue-700 rounded-2xl p-6 text-white">
              ...
              <p className="text-blue-200 text-sm mb-4">
                Need immediate help? Chat with our AI assistant 24/7 or connect with a team member during business hours.
              </p>
              <button className="w-full bg-white text-blue-900 py-3 rounded-xl font-bold hover:bg-blue-50 transition">
                Start Chat
              </button>
            </div>

            <div className="bg-slate-100 rounded-2xl p-6">
              <h3 className="font-bold text-lg text-slate-900 mb-2">Sales Inquiries</h3>
