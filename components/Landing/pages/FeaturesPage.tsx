...
import { 
  Bot, Zap, Users, MessageSquare, Phone, Mail, Layout, BarChart3, 
  Crown, Upload, Brain, Target, Sparkles, ArrowRight, Check, X, 
  ChevronDown, ChevronUp, Send, Mic, Globe, Shield, Clock, 
  TrendingUp, Star, Play, Loader, RefreshCcw
} from 'lucide-react';
...
const coreFeatures = [
  {
    ...
    description: 'Create powerful AI chatbots with our intuitive drag-and-drop builder. No coding skills needed—just describe what you want and watch your bot come to life.',
    highlights: ['Visual drag-and-drop interface', 'Multiple AI personas & personalities', 'Custom conversation flows', 'One-click deployment'],
  ...
  },
  {
    ...
    description: 'Automatically capture, score, and nurture leads 24/7. Our intelligent CRM tracks every conversation and prioritizes your hottest prospects.',
    highlights: ['Automatic lead scoring', 'Conversion tracking', 'Smart follow-ups', 'Pipeline management'],
  ...
  },
  {
    ...
    description: 'Upload documents, paste URLs, or connect data sources. Your bot learns everything about your business and answers questions with perfect accuracy.',
    highlights: ['PDF & document upload', 'Website content scraping', 'FAQ imports', 'Real-time training'],
  ...
  },
  {
    ...
    description: 'Ultra-realistic AI voice agents that handle phone calls, qualify leads, and book appointments. Customers can\'t tell they\'re talking to AI.',
    highlights: ['Cartesia voice synthesis', 'Inbound & outbound calls', 'Call transcription', 'Smart call routing'],
  ...
  },
  {
    ...
    description: 'Create email sequences, SMS campaigns, and automated follow-ups that nurture leads through your funnel—all powered by AI.',
    highlights: ['Email sequences', 'SMS campaigns', 'Drip automation', 'A/B testing'],
  ...
  },
  {
    ...
    description: 'Build beautiful landing pages and forms that convert. Embed your chatbot anywhere and capture leads with high-converting templates.',
    highlights: ['Drag-and-drop pages', 'Form builder', 'Template library', 'Mobile responsive'],
  ...
  },
  {
    ...
    description: 'Understand every conversation with sentiment analysis, topic detection, and actionable insights that help you improve conversions.',
    highlights: ['Sentiment analysis', 'Conversation search', 'Export & reporting', 'Real-time monitoring'],
  ...
  },
  {
    ...
    description: 'Resell BuildMyBot under your own brand. Full white-label customization, custom domains, and generous partner commissions.',
    highlights: ['Custom branding', 'Your own domain', 'Partner dashboard', 'Revenue sharing'],
...
const comparisonData = [
  { feature: 'AI Chatbot Builder', buildmybot: true, intercom: true, drift: true, zendesk: false },
  { feature: 'No-Code Setup', buildmybot: true, intercom: false, drift: false, zendesk: false },
  { feature: 'Voice Agent (AI Phone)', buildmybot: true, intercom: false, drift: false, zendesk: false },
  { feature: 'Lead Scoring', buildmybot: true, intercom: true, drift: true, zendesk: false },
  { feature: 'Knowledge Base Training', buildmybot: true, intercom: true, drift: false, zendesk: true },
  { feature: 'Marketing Automation', buildmybot: true, intercom: true, drift: true, zendesk: false },
  { feature: 'Website Builder', buildmybot: true, intercom: false, drift: false, zendesk: false },
  { feature: 'White-Label Option', buildmybot: true, intercom: false, drift: false, zendesk: false },
  { feature: 'Sentiment Analysis', buildmybot: true, intercom: false, drift: false, zendesk: true },
  { feature: 'Free Tier Available', buildmybot: true, intercom: false, drift: false, zendesk: false },
  { feature: 'Starting Price', buildmybot: '$0/mo', intercom: '$74/mo', drift: '$2,500/mo', zendesk: '$49/mo' },
];
...
export const FeaturesPage: React.FC = () => {
  ...
  const [demoMessages, setDemoMessages] = useState<{role: 'user'|'bot', text: string}[]>([
    { role: 'bot', text: 'Hi! 👋 I\'m the BuildMyBot demo assistant. Ask me anything about our features!' }
  ]);
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center space-y-8">
              ...
              <p className="text-xl text-blue-100/80 max-w-3xl mx-auto leading-relaxed">
                From chatbots to voice agents, lead capture to marketing automation—BuildMyBot gives you 
                everything to convert visitors into customers, 24/7.
              </p>
              
              <div className="flex flex-wrap justify-center gap-4 pt-4">
                <a href="/" className="group inline-flex items-center gap-2 bg-white text-blue-900 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-2xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-105">
                  Start Building Free
                  <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="#demo" className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white border border-white/20 px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all">
                  <Play size={18} />
                  Watch Demo
                </a>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Everything you need to automate conversations, capture leads, and grow your business—without the complexity.
              </p>
            </div>
              ...
              {coreFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-white mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        ...
        <section id="demo" className="py-24 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Try our live demo and experience how BuildMyBot handles real conversations.
              </p>
            </div>
              ...
              <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-xs">Powered by AI • Always Online</p>
                  </div>
                ...
                <div ref={chatRef} className="h-80 overflow-y-auto p-4 space-y-4 bg-slate-50">
                ...
                <div className="p-4 border-t border-slate-200 bg-white">
                  ...
                  <div className="flex gap-2 mt-3">
                    {['How does AI training work?', 'Tell me about Voice Agent', 'Pricing info'].map((q, i) => (
                      <button 
                        key={i}
                  ...
                  <tr className="border-b border-slate-700">
                    ...
                    <th className="py-4 px-4">
                      <div className="flex flex-col items-center">
                        ...
                        <span className="font-bold text-blue-400">BuildMyBot</span>
                      </div>
                    </th>
                    ...
                    <tr key={i} className="border-b border-slate-800 hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="py-4 px-4 text-center">
                        {typeof row.buildmybot === 'boolean' ? (
                          ...
                          <span className="text-emerald-400 font-bold">{row.buildmybot}</span>
                        )}
                      </td>
                      <td className="py-4 px-4 text-center">
                        {typeof row.intercom === 'boolean' ? (
                          row.intercom ? (
                            <Check size={20} className="text-slate-400 mx-auto" />
                          ) : (
                            <X size={20} className="text-slate-600 mx-auto" />
                          )
                        ) : (
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Connect BuildMyBot with your favorite tools and supercharge your workflow.
              </p>
            </div>
            ...
            <div className="text-center mt-12">
              <p className="text-slate-500 mb-4">...and 50+ more integrations available</p>
        ...
        <section className="py-24 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-12 text-center">
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
              Join thousands of businesses using BuildMyBot to automate conversations, capture more leads, and grow revenue—all while you sleep.
            </p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <a href="/" className="group inline-flex items-center gap-2 bg-white text-blue-700 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-2xl hover:shadow-white/25 hover:scale-105">
                Get Started Free
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="/contact" className="inline-flex items-center gap-2 bg-white/10 backdrop-blur text-white border border-white/30 px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all">
                Talk to Sales
              </a>
            </div>
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className={`shrink-0 w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 transition-transform duration-300 ${openFaq === i ? 'rotate-180' : ''}`}>
                      <ChevronDown size={18} />
                    </div>
                  </button>
