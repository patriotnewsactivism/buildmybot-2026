        ...
        <div className="p-8">
          ...
          {step === 1 && (
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-3xl font-bold text-slate-900">Choose Your Industry</h2>
              </div>
              <p className="text-slate-600 mb-8">We'll customize templates and guidance for your industry.</p>
          ...
          {step === 2 && (
            <div>
              ...
              <p className="text-slate-600 mb-8">Tell us what you want your bot to accomplish.</p>
                ...
                {goals.map((goal) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {data.goal === goal && <CheckCircle className="text-blue-600" size={20} />}
                    </div>
                  </button>
                ))}
              </div>
          ...
          {step === 3 && (
            <div>
              ...
              <p className="text-slate-600 mb-8">Review your selections and we'll create your first bot.</p>

              <div className="bg-slate-50 rounded-lg p-6 space-y-4">
                <div>
                  <span className="text-sm text-slate-600">Industry:</span>
                  <p className="font-semibold text-slate-900">{data.industry || 'Not selected'}</p>
                </div>
                <div>
                  <span className="text-sm text-slate-600">Primary Goal:</span>
                  <p className="font-semibold text-slate-900">{data.goal || 'Not selected'}</p>
                </div>
              </div>

              <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-900">
                  We'll create a bot optimized for {data.industry} businesses focused on {data.goal?.toLowerCase()}.
