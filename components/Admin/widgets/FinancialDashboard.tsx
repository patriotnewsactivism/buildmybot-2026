...
export const FinancialDashboard: React.FC = () => {
  ...
  const [stripeHealth, setStripeHealth] = useState<{ ok: boolean; productCount?: number } | null>(null);
  ...
  const invoiceColumns: Column<StripeInvoice>[] = [
    ...
    },
    {
      ...
      label: 'Created',
      sortable: true,
      render: (invoice) => new Date(invoice.created * 1000).toLocaleDateString(),
    },
  ];
  ...
  const refundColumns: Column<StripeRefund>[] = [
    {
      ...
      label: 'ID',
      render: (refund) => (
        <code className="text-xs font-mono">{refund.id.substring(0, 20)}...</code>
      ),
    },
    {
      key: 'amount',
  ...
  const payoutColumns: Column<Payout>[] = [
    {
      ...
      label: 'Partner ID',
      render: (payout) => (
        <code className="text-xs font-mono">{payout.partnerId.substring(0, 12)}...</code>
      ),
    },
    {
      key: 'amountCents',
  ...
  return (
    <div>
      ...
      {/* Partner Payouts */}
      <div className="mb-8">
        <h3 className="text-lg font-semibold text-slate-900 mb-4">Partner Payouts</h3>
        <DataTable
      ...
      {/* Recent Refunds */}
      <div>
        <h3 className="text-lg font-semibold text-slate-900 mb-4">Recent Refunds</h3>
        <DataTable
