  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-slate-900">Live System Metrics</h2>
      ...
      {!loading && (
        <div className="mt-6 bg-slate-50 rounded-lg p-4">
          <h3 className="text-sm font-semibold text-slate-700 mb-2">Database Pool Details</h3>
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              <span className="text-slate-600">Total:</span>
              <span className="ml-2 font-medium text-slate-900">{metrics.dbConnections}</span>
            </div>
            <div>
              <span className="text-slate-600">Idle:</span>
              <span className="ml-2 font-medium text-slate-900">{metrics.dbIdleConnections}</span>
            </div>
            <div>
              <span className="text-slate-600">Waiting:</span>
              <span className="ml-2 font-medium text-slate-900">{metrics.dbWaitingConnections}</span>
            </div>
          </div>
        </div>
      )}
