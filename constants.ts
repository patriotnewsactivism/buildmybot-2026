...
export const AVAILABLE_MODELS = [
  { id: 'gpt-5o-mini', name: 'GPT-5o Mini', description: 'Fast, cost-effective. Best for real-time chat. 33% lower cost than GPT-4o Mini.' },
  { id: 'gpt-4o-mini', name: 'GPT-4o Mini', description: 'Legacy model. Consider upgrading to GPT-5o Mini for cost savings.' },
...
export const VOICE_AGENT_PRICING = [
  { 
    ...
    features: ['100 minutes/month', 'Cartesia ultra-realistic voice', 'Basic call routing', 'Call transcripts']
  },
  { 
    ...
    features: ['500 minutes/month', 'All Cartesia voices', 'Call transfers & scheduling', 'CRM integration', 'Analytics dashboard']
  },
  { 
    id: 'voice_enterprise', 
    ...
    features: ['2000 minutes/month', 'Custom voice cloning', 'Multi-language support', 'Priority support', 'White-label ready', 'API access']
  },
];
