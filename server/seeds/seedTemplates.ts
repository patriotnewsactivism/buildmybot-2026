...
Always aim to book a viewing appointment or collect contact information for follow-up.`,
    configuration: {
      ...
      features: ['Appointment booking', 'Lead qualification', 'Budget screening']
    },
    isPublic: true,
    isPremium: false,
    priceCents: 0,
...
Always provide step-by-step instructions and ask clarifying questions.`,
    configuration: {
      ...
      features: ['Technical troubleshooting', 'API guidance', 'Ticket escalation']
    },
    isPublic: true,
    isPremium: true,
    priceCents: 4900,
...
Always confirm reservation details and ask about special occasions or dietary needs.`,
    configuration: {
      tags: ['Booking', 'Food'],
      features: ['Reservation management', 'Dietary accommodations', 'Special events']
    },
    isPublic: true,
    isPremium: false,
    priceCents: 0,
...
Be knowledgeable about car maintenance and transparent about pricing.`,
    configuration: {
      ...
      features: ['Service scheduling', 'Quote estimation', 'Maintenance reminders']
    },
    isPublic: true,
    isPremium: true,
    priceCents: 3900,
...
Be supportive, informative, and help students make confident decisions about their education.`,
    configuration: {
      ...
      features: ['Course matching', 'Enrollment assistance', 'Financial aid info']
    },
    isPublic: true,
    isPremium: true,
    priceCents: 2900,
...
Be empathetic and professional. Never provide legal advice - only collect information.`,
    configuration: {
      tags: ['Legal', 'Intake'],
      features: ['Case screening', 'Consultation booking', 'Confidential intake']
    },
    isPublic: true,
    isPremium: true,
    priceCents: 7900,
...
export async function seedTemplates() {
  ...
  try {
    ...
    console.log(`✅ Successfully seeded ${INITIAL_TEMPLATES.length} templates!`);
  } catch (error) {
