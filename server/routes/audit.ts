...
// ========================================
router.get('/organization/:orgId', authorize(['MasterAdmin', 'Admin', 'ADMIN', 'Partner']), async (req: Request, res: Response) => {
  try {
...
// ========================================
router.get('/user/:userId', authorize(['MasterAdmin', 'Admin', 'ADMIN']), async (req: Request, res: Response) => {
  try {
