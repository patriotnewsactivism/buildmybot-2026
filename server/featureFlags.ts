...
export const FEATURES: FeatureFlags = {
  ...
  PARTNER_IMPERSONATION: parseEnvBool(process.env.FEATURE_PARTNER_IMPERSONATION, true),
  ...
  ADVANCED_ANALYTICS: parseEnvBool(process.env.FEATURE_ADVANCED_ANALYTICS, true),
  REAL_TIME_METRICS: parseEnvBool(process.env.FEATURE_REAL_TIME_METRICS, false),

  // Bot building experience
  BOT_TEMPLATES_MARKETPLACE: parseEnvBool(process.env.FEATURE_BOT_TEMPLATES, true),
  SIMPLIFIED_BOT_WIZARD: parseEnvBool(process.env.FEATURE_SIMPLIFIED_WIZARD, true),
